...
- Frontend is deployed and READY at `https://web-three-teal-52.vercel.app`; hydration/read proof showed `LIVE · STUDIONET` and project 1 `FINALIZED`. Connect-wallet testing correctly failed closed because no injected EIP-1193 wallet was exposed; no hosted write is claimed.
